...
export interface IEasyWorkerInstance<TPayload = null, TResult = void> {
     ...
     * */
    onMessage(callback: (message: IEasyWebWorkerMessage<TPayload, TResult>, event: MessageEvent<IMessageData<TPayload>>) => void): void;
    /**
     * Use this method to defined which will be the functionality of your worker when a message is send  to it
     ...
     * @param {MessageEvent} callback.event - This is the event that was received
     * */
    onMessage<TPayload_ = null, TResult_ = void>(method: string, callback: (message: IEasyWebWorkerMessage<TPayload_, TResult_>, event: MessageEvent<IMessageData<TPayload_>>) => void): void;
    /**
 ...
 */
export type EasyWebWorkerBody<IPayload = null, IResult = void, TPrimitiveParameters extends any[] = unknown[]> = (
/**
...
export type TMessagePostType = 'progress' | 'resolved' | 'rejected' | 'canceled' | 'worker_cancelation';
export type TMessageCallback = (messageData: IMessageData<any>, transfer: Transferable[]) => void;
export type TMessageCallbackType = 'onResolve' | 'onCancel' | 'onReject' | 'onProgress' | 'onFinalize';
...
export interface IEasyWebWorkerMessage<TPayload = null, TResult = void> {
     ...
     * */
    readonly reportProgress: (percentage: number, payload?: unknown, transfer?: Transferable[]) => void;
    /**
     * This method is used to resolve the message from inside the worker
     * */
    readonly resolve: [TResult] extends [void] ? () => void : (payload: TResult, transfer?: Transferable[]) => void;
    /**
